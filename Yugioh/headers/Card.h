...
enum class CardLocation { HAND, DECK, GRAVEYARD, FIELD, ATTACK, DEFENSE, SPELL_TRAP_ZONE };
...
protected:
  ...
  Card(const std::string& cardName, CardType cardType, CardLocation cardLocation,
