...
public:
    ...
    void setupUi(QMainWindow *MainMenu)
    {
        ...
        verticalLayoutWidget->setGeometry(QRect(80, 160, 891, 371));
        ...
        btnProfileSettings = new QPushButton(verticalLayoutWidget);
        ...
        verticalLayout->addWidget(btnProfileSettings);

        btnDeckSettings = new QPushButton(verticalLayoutWidget);
        ...
        verticalLayout->addWidget(btnDeckSettings);

        btnGameSettings = new QPushButton(verticalLayoutWidget);
        ...
        verticalLayout->addWidget(btnGameSettings);
