...
auto Serializer::getCards() -> std::vector<Card*> { return arrayOfCards; }
...
void Serializer::loadFromJson(QString s) {
  ...
  for (auto item : arr) {
    ...
    if (item.toObject()["type"].toString() == "Normal Monster" ||
        item.toObject()["type"].toString() == "Effect Monster") {
      ...
      MonsterAttribute attribute =
          Maps::stringToMonsterAttribute[item.toObject()["attribute"].toString()];
      ...
      auto* monsterCard =
          new MonsterCard(name, atk, def, level, type, race, attribute, false, position, false,
                          cardType, CardLocation::DECK, desc, imagePath, false);
      ...
      auto* spellCard = new SpellCard(spellType, name, cardType, CardLocation::DECK, position, desc,
                                      imagePath, false);
      ...
      auto* trapCard = new TrapCard(trapType, name, cardType, CardLocation::DECK, position, desc,
...
std::map<QString, TrapType> Maps::stringToTrapType{{"NORMAL TRAP", TrapType::NORMAL_TRAP},
...
std::map<QString, SpellType> Maps::stringToSpellType{
    {"NORMAL SPELL", SpellType::NORMAL_SPELL}, {"CONTINUOUS SPELL", SpellType::CONTINUOUS_SPELL},
    {"EQUIP SPELL", SpellType::EQUIP_SPELL},   {"QUICK SPELL", SpellType::QUICK_SPELL},
    {"FIELD SPELL", SpellType::FIELD_SPELL},   {"RITUAL SPELL", SpellType::RITUAL_SPELL}};

std::map<QString, MonsterAttribute> Maps::stringToMonsterAttribute{
    {"DARK", MonsterAttribute::DARK},     {"LIGHT", MonsterAttribute::LIGHT},
    {"DIVINE", MonsterAttribute::DIVINE}, {"EARTH", MonsterAttribute::EARTH},
    {"FIRE", MonsterAttribute::FIRE},     {"WATER", MonsterAttribute::WATER},
