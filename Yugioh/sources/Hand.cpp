...
Hand::Hand() : m_x(0), m_y(0){};
Hand::Hand(std::vector<Card*>& initialHand) : CardList(initialHand) {}

auto Hand::getHand() const -> std::vector<Card*> { return this->m_cardList; }
...
auto Hand::size() const -> float { return this->m_cardList.size(); }
