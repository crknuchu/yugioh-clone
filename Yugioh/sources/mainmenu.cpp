...
MainMenu::MainMenu(QWidget *parent)
  ...
  music->setMedia(
      QUrl("qrc:/resources/sounds/illusion.mp3")); // in qt5 is setMedia()
  music->play();
  musicActive = true;
...
void MainMenu::onStartButtonClick() {
  ...
  m_pGame = new Game(*player1, *player2, this->getLifePointsJson(),
                     this->getNumberOfCardsJson(), this->getTimePerMoveJson());
...
void MainMenu::setGame(Game *newGame) { m_pGame = newGame; }
