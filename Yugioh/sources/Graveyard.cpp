...
Graveyard::Graveyard() : m_x(0), m_y(0) {}
...
Graveyard::Graveyard(std::vector<Card*>& initialGraveyard) : CardList(initialGraveyard) {
...
auto Graveyard::getGraveyard() const -> std::vector<Card*> { return m_cardList; }
...
auto Graveyard::boundingRect() const -> QRectF { return {m_x, m_y, m_width, m_height}; }
