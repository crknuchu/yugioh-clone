...
SpellCard::SpellCard(SpellType type, const std::string &cardName,
    ...
    : Card(cardName, cardType, cardLocation, cardDescription, imagePath),
      type(type), active(active), position(position) {}

auto SpellCard::clone() -> SpellCard * {
  return new SpellCard(this->type, this->cardName, this->cardType,
                       this->cardLocation, this->position,
...
auto SpellCard::getSpellType() const -> SpellType { return type; }

auto SpellCard::getSpellTypeString() const -> std::string {
  switch (type) {
  case SpellType::NORMAL_SPELL: return "normal spell";
  case SpellType::CONTINUOUS_SPELL: return "constinious spell";
  case SpellType::EQUIP_SPELL: return "equip spell";
  case SpellType::QUICK_SPELL: return "quick spell";
  case SpellType::FIELD_SPELL: return "field spell";
  case SpellType::RITUAL_SPELL: return "ritual spell";
  default: return "error:unknown spell type";
  }
}
...
void SpellCard::activateSpell() { this->active = true; }
...
void SpellCard::setCardMenu(bool isMonsterZoneFull, bool OpponentHaveMonsters) {
  ...
  bool cardActivationRequirement =
      effectRequirement.isActivatable(this->cardName);
...
auto SpellCard::getActive() const -> bool { return active; };
