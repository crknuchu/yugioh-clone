...
const std::map<std::string, EffectRequirement::EFFECT_REQUIREMENT_MEMBER_FUNCTION_POINTER>
...
auto EffectRequirement::haneHaneReq() -> bool { return EffectRequirement::fissureReq(); }
