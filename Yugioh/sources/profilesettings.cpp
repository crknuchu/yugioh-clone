...
profileSettings::profileSettings(QWidget *parent)
    : QWidget(parent), ui(new Ui::profileSettings) {
  ui->setupUi(this);
...
void profileSettings::setUpConnections() {
  connect(ui->nextAvatar, &QPushButton::clicked, this,
          &profileSettings::changeAvatar);
  connect(ui->lastAvatar, &QPushButton::clicked, this,
          &profileSettings::changeAvatar);

  connect(ui->nextSleeve, &QPushButton::clicked, this,
          &profileSettings::changeSleeveNext);
  connect(ui->lastSleeve, &QPushButton::clicked, this,
          &profileSettings::changeSleevePrevious);

  connect(ui->save, &QPushButton::clicked, this, &profileSettings::saveChanges);
  connect(ui->cancel, &QPushButton::clicked, this,
          &profileSettings::undoChanges);
}

auto profileSettings::getAvatar() -> avatars { return currentAvatar; }

auto profileSettings::getSleeve() -> sleeves { return currentSleeve; }

profileSettings::~profileSettings() { delete ui; }
